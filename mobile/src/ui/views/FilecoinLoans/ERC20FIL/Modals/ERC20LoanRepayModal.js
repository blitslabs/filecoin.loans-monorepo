                        ...
                        <SafeAreaView style={styles.wrapper}>
                            ...
                            <View style={styles.txDetailsContainer}>
                                ...
                                <View style={{ marginTop: 10 }}>
                                    <Text style={styles.dataDescription}>You repaying a loan of 302.46575342 DAI</Text>
                                </View>
                                <View style={{ marginTop: 10 }}>
                                ...
                                <View style={{ marginTop: 10 }}>
                                    ...
                                    <Text style={styles.dataValue}>2021-06-14T23:51:49-05:00</Text>
                                </View>
                            </View>

                            <View style={styles.btnsContainer}>                                
                                <View style={{ flex: 1 }}>
                                    <BlitsBtn style={{ backgroundColor: '#0062FF' }} title="Repay Loan" onPress={() => handleConfirmBtn()} />
                                </View>
                            </View>
                        </SafeAreaView>
                        :
