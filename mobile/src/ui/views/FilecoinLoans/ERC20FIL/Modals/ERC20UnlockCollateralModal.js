                    ...
                    modalState === 0
                        ...
                        <SafeAreaView style={styles.wrapper}>
                            ...
                            <View style={styles.btnsContainer}>
                                ...
                                <View style={{ flex: 1 }}>
                                    <BlitsBtn style={{ backgroundColor: '#0062FF' }} title="Redeem" onPress={() => handleConfirmBtn()} />
                                </View>
                            </View>
                        </SafeAreaView>
                        :
                                    ...
                                    : modalState === 4 ?
                                        <SafeAreaView style={styles.wrapper}>
                                            ...
                                            <View style={styles.txDetailsContainer}>
                                                ...
                                                <View style={{}}>
                                                    <Text style={styles.dataDescription}>You'll be able to collect the funds in the Payment Channel in 11 hours and 59 minutes.</Text>
                                                </View>
