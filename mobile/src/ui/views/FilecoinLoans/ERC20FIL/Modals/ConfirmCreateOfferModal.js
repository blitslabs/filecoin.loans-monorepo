...
class ConfirmCreateOfferModal extends Component {
                    ...
                    <View style={styles.txDetailsContainer}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <ImageLoad
                                    source={{ uri: `${API}/static/logo/${prepareTx?.principalAsset}` }}
                                ...
                                <View style={{ justifyContent: 'center', alignItems: 'center', marginLeft: 5 }}>
                                    <Text style={{ fontFamily: 'Poppins-Regular' }}>{prepareTx?.principalAmount} {prepareTx?.principalAsset}</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                />
                                <View style={{ justifyContent: 'center', alignItems: 'center', marginLeft: 5 }}>
                                    <Text style={{ fontFamily: 'Poppins-Regular' }}>{parseFloat(prepareTx?.interestAmount).toFixed(6)} {prepareTx?.principalAsset}</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={{ fontFamily: 'Poppins-SemiBold' }}>Total Repayment Amount</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <ImageLoad
                                    source={{ uri: `${API}/static/logo/${prepareTx.principalAsset}` }}
                                ...
                                />
                                <View style={{ justifyContent: 'center', alignItems: 'center', marginLeft: 5 }}>
                                    <Text style={{ fontFamily: 'Poppins-Regular' }}>{parseFloat(prepareTx?.repaymentAmount).toFixed(6)} {prepareTx?.principalAsset}</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 5 }}>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={{ fontFamily: 'Poppins-SemiBold' }}>Est. Collateral Amount</Text>
                            </View>
                            <Text style={{ fontFamily: 'Poppins-Regular' }}>{parseFloat(BigNumber(prepareTx?.principalAmount).dividedBy(prices?.FIL?.usd).multipliedBy(1.5)).toFixed(2)} FIL</Text>
                        </View>
                    </View>
...
export default connect(mapStateToProps)(ConfirmCreateOfferModal)