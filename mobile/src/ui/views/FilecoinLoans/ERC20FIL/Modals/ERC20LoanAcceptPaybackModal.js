...
class ERC20LoanAcceptModal extends Component {
    ...
    handleSignBtn = async () => {
        ...
        const { filecoinLoans, loanDetails, wallet, chainId, blockchain } = this.props
        ...
        let accountLoans
        try {
            accountLoans = await erc20Loans.getAccountLoans(wallet?.[blockchain]?.publicKey)
        } catch (e) {
            console.log(e)
            this.setState({ signLoading: false })
            return
    ...
    handleAcceptBtn = async () => {
        ...
        let response
        try {
            response = await erc20Loans.acceptRepayment(
    ...
    render() {
        ...
        const {
            modalState, txLoading, txHash, signLoading, secretB1, repayAmount
        } = this.state
                        ...
                        <SafeAreaView style={styles.wrapper}>
                            ...
                            <View style={styles.txDetailsContainer}>
                                ...
                                <View style={{ marginTop: 10 }}>
                                    <Text style={[styles.dataDescription, { fontSize: 12 }]}>You generating the secret required to accept the borrower's repayment of {repayAmount} {asset?.symbol}</Text>
                                </View>
                                <View style={{ marginTop: 10 }}>
                                ...
                                <View style={{ marginTop: 10 }}>
                                    ...
                                    <Text style={styles.dataValue}>{moment.unix(loanDetails?.erc20Loan?.acceptExpiration).format()}</Text>
                                </View>
                        ...
                        modalState === 1 ?
                            <SafeAreaView style={styles.wrapper}>
                                ...
                                <View style={styles.btnsContainer}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <BlitsBtn style={{ backgroundColor: '#0062FF' }} title="Accept Payback" onPress={() => this.handleAcceptBtn()} />
                                    </View>
                                </View>
                            </SafeAreaView>
                            :
                            modalState === 2
                                ...
                                <SafeAreaView style={styles.wrapper}>
                                    ...
                                    <View style={{ alignItems: 'center', marginBottom: 50, marginHorizontal: 40 }}>
                                        ...
                                        <Text style={{ fontFamily: 'Poppins-Regular' }}>Accepting Payback</Text>
                                ...
                                <SafeAreaView style={styles.wrapper}>
                                    ...
                                    <View style={{ alignItems: 'center', marginBottom: 0, marginHorizontal: 40 }}>
                                        ...
                                        <Text style={{ fontFamily: 'Poppins-Regular', textAlign: 'center' }}>You have accepted the Borrower's repayment and revealed your secret (secretB1), which will allow the Borrower to unlock the collateral. The Loan is now closed.</Text>
                                        {/* <Text style={{ fontFamily: 'Poppins-Light', textAlign: 'center', marginTop: 10 }}>This process can take up to 1 min to complete. Please don't close the app.</Text> */}
                                    </View>
                                    <View style={styles.btnsContainer}>
                                        <View style={{ flex: 1 }}>
