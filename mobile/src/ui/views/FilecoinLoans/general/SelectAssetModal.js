...
class SelectAssetModal extends Component {
    ...
    render() {
        ...
        const { isVisible, onClose, onAssetSelect, blockchain, tokens, filteredTokens } = this.props
            ...
            >
                <SafeAreaView style={styles.wrapper}>
                    ...
                    <ScrollView>
                        ...
                        {
                            Object.values(filteredTokens).filter(t => t.chainType === blockchain).sort((a, b) => parseFloat(a?.balance) < parseFloat(b?.balance)).map((t, i) => (
                                <TouchableOpacity
                                    key={i}
                                ...
                                >
                                    ...
                                    <View style={styles.accountTextContainer}>
                                        ...
                                        <Text style={styles.balanceText}>Balance: {tokens[t?.contractAddress]?.balance}</Text>
                                    </View>
                                </TouchableOpacity>
                            ))
                        }
...
function mapStateToProps({ balances, wallet, tokens }) {
    return {        
        balances,
