                    ...
                    modalState === 0
                        ...
                        <SafeAreaView style={styles.wrapper}>
                            ...
                            <View style={styles.txDetailsContainer}>
                                ...
                                <View style={{}}>
                                    <Text style={styles.dataDescription}>You are accepting the borrowers's payback (1.00827752 FIL).</Text>
                                </View>
                                ...
                                <View style={{ marginTop: 10 }}>
                                    ...
                                    <Text style={styles.dataValue}>1 FIL</Text>
                                </View>
                                <View style={{ marginTop: 10 }}>
                        ...
                        modalState === 1 ?
                            <SafeAreaView style={styles.wrapper}>
                                ...
                                <View style={styles.txDetailsContainer}>
                                    ...
                                    <View style={{}}>
                                        <Text style={styles.dataDescription}>You are accepting the Borrower's payback (1.00827752 FIL).</Text>
                                    </View>
                                ...
                                <View style={styles.btnsContainer}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <BlitsBtn style={{ backgroundColor: '#0062FF' }} title="Redeem Voucher" onPress={() => handleConfirmBtn()} />
                                    </View>
                                </View>
                            </SafeAreaView>
                            :
                                    ...
                                    : modalState === 4 ?
                                        <SafeAreaView style={styles.wrapper}>
                                            ...
                                            <View style={styles.txDetailsContainer}>
                                                ...
                                                <View style={{}}>
                                                    <Text style={styles.dataDescription}>You are settling the payment channel to withdraw the loan's principal (1 FIL).</Text>
                                                </View>
                                            ...
                                            <View style={styles.btnsContainer}>
                                                ...
                                                <View style={{ flex: 1 }}>
                                                    <BlitsBtn style={{ backgroundColor: '#0062FF' }} title="Settle" onPress={() => handleConfirmBtn()} />
                                                </View>
                                            </View>
                                        </SafeAreaView>
                                        :
                                        <SafeAreaView style={styles.wrapper}>
                                            ...
                                            <View style={styles.txDetailsContainer}>
                                                ...
                                                <View style={{}}>
                                                    <Text style={styles.dataDescription}>You'll be able to collect the funds in the Payment Channel in 11 hours and 58 minutes.</Text>
                                                </View>
                                            ...
                                            <View style={styles.btnsContainer}>
                                                ...
                                                <View style={{ flex: 1 }}>
                                                    <BlitsBtn style={{ backgroundColor: '#0062FF' }} title="Collect" onPress={() => handleConfirmBtn()} />
                                                </View>
                                            </View>
                                        </SafeAreaView>
