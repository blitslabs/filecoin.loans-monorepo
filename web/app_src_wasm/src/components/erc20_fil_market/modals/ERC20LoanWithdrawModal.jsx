...
class ERC20LoanWithdrawModal extends Component {
    ...
    handleConfirmBtn = async (e) => {
        ...
        dispatch(saveTx({
            ...
            summary: `Withdraw ${loanDetails?.erc20Loan?.principalAmount} ${loanAssets[loanDetails?.erc20Loan?.token]?.symbol} Principal `,
                ...
                <div style={{ padding: '24px 48px', height: '100%', }}>
...

                    {
                        ...
                        <Fragment>
                            ...
                            <div className="mt-4">
                                <div>Secret Hash A1</div>
                                <div className="mt-2" style={{ fontWeight: 600, fontSize: 14, overflowWrap: 'break-word' }}>{loanDetails?.erc20Loan?.secretHashA1}</div>
                            </div>
...

                    {
                        ...
                        <Fragment>
                            ...
                            <div style={{ padding: '0px 24px 48px 24px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                                ...
                                <div style={{ fontWeight: 500, fontSize: 16, marginTop: 5 }}>Withdrawing Principal </div>
                            </div>
                        </Fragment>
                    }

                    {
                        ...
                        <Fragment>
                            ...
                            <div style={{ padding: '0px 24px 24px 24px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                                ...
                                <div style={{ fontWeight: 400, fontSize: 16, marginTop: 25, marginBottom: 15, textAlign: 'center' }}>You have withdrawn the loan's principal. You have until the loan's expiration date to repay the loan.</div>
