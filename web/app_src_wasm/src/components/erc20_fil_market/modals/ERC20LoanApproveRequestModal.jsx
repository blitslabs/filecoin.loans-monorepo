            ...
            confirmERC20LoanOperation(params)
                ...
                .then((res) => {
                    if (res.status === 'OK') {
                        ...
                        toast.success('Request Approved', { position: "top-right", autoClose: 5000, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined, });
