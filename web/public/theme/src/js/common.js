...
(function() {
    ...
    options.each(function(){
        let item = $(this);
            btn = item.find('.js-options-btn'),
            dropdown = item.find('.js-options-dropdown'),
            close = item.find('.js-options-close');
...
// options1
(function() {
    const options = $('.js-options1');
    options.each(function(){
        let option = $(this);
            btn = option.find('.js-options1-btn'),
            dropdown = option.find('.js-options1-dropdown'),
            items = option.find('.js-options1-item');
        btn.on('click', function(e){
            e.stopPropagation();
            e.preventDefault();
        ...
        items.each(function(){
            let item = $(this);
                head = item.find('.js-options1-head'),
                body = item.find('.js-options1-body');
            head.on('click', function(e){
                e.stopPropagation();
                e.preventDefault();
                if(!item.hasClass('active')){
...
(function() {
    ...
    dropdowns.each(function(){
        let dropdown = $(this);
            head = dropdown.find('.js-dropdown-head'),
            body = dropdown.find('.js-dropdown-body');
        head.on('click', function(e){
            e.stopPropagation();
            e.preventDefault();
