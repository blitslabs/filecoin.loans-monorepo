...
(function(){
  ...
  var sparkOptions1 = {
    ...
    labels: [...Array(7).keys()].map(n => `2020-09-0${n+1}`),
    yaxis: {
      min: 0
    },
    xaxis: {
...
(function(){
  var options = {
    ...
    tooltip: {
      ...
      custom: function({labels, series, seriesIndex, dataPointIndex, w}) {
        return '<div class="tooltip__box">' +
          '<span class="tooltip__price">$' + series[seriesIndex][dataPointIndex] + '<svg class="icon icon-arrow-top"><use xlink:href="img/sprite.svg#icon-arrow-top"></use></svg></span>' +
          '<span class="tooltip__date">On Saturday</span>' +
          '</div>'
      }
    },
    fill: {
...
(function(){
  var options = {
    ...
    tooltip: {
      ...
      custom: function({labels, series, seriesIndex, dataPointIndex, w}) {
        return '<div class="tooltip__box">' +
          '<span class="tooltip__title">Earning Details</span>' +
          '<span class="tooltip__line"><svg class="icon icon-arrow-bottom"><use xlink:href="img/sprite.svg#icon-arrow-bottom"></use></svg><span class="tooltip__text">Income</span> <span class="tooltip__price">$600</span></span>' +
          '<span class="tooltip__line"><svg class="icon icon-arrow-top"><use xlink:href="img/sprite.svg#icon-arrow-top"></use></svg><span class="tooltip__text">Income</span><span class="tooltip__price">$' + series[seriesIndex][dataPointIndex] + '</span></span>' +
          '</div>'
      }
    },
    markers: {
